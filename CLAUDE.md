...
- `/[slug]` (`src/app/[slug]/page.tsx`) — one page per section (`intrn`, `moro-agami`, `crypto-club`, `more`), statically generated via `generateStaticParams`, rendered from that section's typed `blocks`.
